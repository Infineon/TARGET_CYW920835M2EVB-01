...
# Patch variables
#
CY_CORE_PATCH=$(CY_INTERNAL_BASELIB_PATH)/internal/20835B1/patches/patch.elf
CY_CORE_CGSLIST=$(CY_INTERNAL_BASELIB_PATH)/internal/20835B1/patches/patch.cgs
CY_CORE_PATCH_CFLAGS=$(CY_INTERNAL_BASELIB_PATH)/internal/20835B1/gcc/20835B1.cflag
CY_CORE_PATCH_LIB_PATH=libraries/prebuilt

#
# Variables for pre-build and post-build processing
#
CY_CORE_HDF=$(CY_INTERNAL_BASELIB_PATH)/internal/20835B1/configdef20835B1.hdf
CY_CORE_HCI_ID=$(CY_INTERNAL_BASELIB_PATH)/platforms/IDFILE.txt
CY_CORE_BTP=$(CY_INTERNAL_BASELIB_PATH)/platforms/20835_SFLASH.btp

ifeq ($(OPUS_CELT_ENCODER),1)
CY_CORE_CGSLIST+=$(CY_INTERNAL_BASELIB_PATH)/platforms/CYW20835B1_OPUS_CELT.cgs
else
CY_CORE_CGSLIST+=$(CY_INTERNAL_BASELIB_PATH)/platforms/CYW20835B1.cgs
endif

CY_CORE_MINIDRIVER=$(CY_INTERNAL_BASELIB_PATH)/platforms/minidriver-20835B1-uart.hex
